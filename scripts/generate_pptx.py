...
SLIDES = [
    ...
    ("Pinecone Design", ["candidate_resume records store resume vectors and metadata.", "company_knowledge records store establishment and growth data.", "Role matching can use both candidate data and company context."]),
